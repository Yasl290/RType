...
private:
  enum class TextOrigin { Center, LeftCenter };
  ...
  void setupButtonText(sf::Text &text, const sf::String &label,
  ...
  sf::Text _resolutionLabelText;
  sf::Text _controlsTitleText;
  sf::Text _controlsDetailsText;
