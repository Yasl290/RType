...
void GameOverScreen::render(sf::RenderWindow& window)
{
    ...
    _restartText.setFillColor(_selectedOption == 0 ? sf::Color::Yellow : sf::Color::White);
    _menuText.setFillColor(_selectedOption == 1 ? sf::Color::Yellow : sf::Color::White);
    _quitText.setFillColor(_selectedOption == 2 ? sf::Color::Yellow : sf::Color::White);
